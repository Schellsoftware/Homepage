...
public class Nachfrage extends Applet implements Runnable{
	...
	String str;
	Image schnitzel_einfach, schnitzel_mittel, schnitzel_nobel;
	Image teller_einfach, teller_mittel, teller_nobel;
	int zeit=4;
	int px[] = new int[3];
	int py[] = new int[3];
	public void init()
	{
		...
		g=null;
		resize(400, 300);
		schnitzel_einfach = getImage(getCodeBase(),"schnitzel_einfach.jpg");
		schnitzel_mittel = getImage(getCodeBase(),"schnitzel_mittel.jpg");
		schnitzel_nobel = getImage(getCodeBase(),"schnitzel_nobel.jpg");
		teller_einfach = getImage(getCodeBase(),"teller_einfach.jpg");
		teller_mittel = getImage(getCodeBase(),"teller_mittel.jpg");
		teller_nobel = getImage(getCodeBase(),"teller_nobel.jpg");
		MediaTracker mt = new MediaTracker(this);
		mt.addImage(schnitzel_einfach,0);
		mt.addImage(schnitzel_mittel,1);
		mt.addImage(schnitzel_nobel,2);
		mt.addImage(teller_einfach,3);
		mt.addImage(teller_mittel,4);
		mt.addImage(teller_nobel,5);
		try {
			mt.waitForAll();
	...
	public void zeichneZyklus()
	{
		...
		if(zeit<1)	g.drawImage(teller_nobel,200,0,this);
		else g.drawImage(schnitzel_nobel,200,0,this);
		if(zeit<2)g.drawImage(teller_mittel,200,100,this);
		else g.drawImage(schnitzel_mittel,200,100,this);
		if(zeit<3)g.drawImage(teller_einfach,200,200,this);
		else g.drawImage(schnitzel_einfach,200,200,this);
		/*
		if(zeit<200){
