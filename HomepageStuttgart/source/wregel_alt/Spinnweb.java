 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class Spinnweb extends Applet implements Runnable{
	...
	public void init()
	{
		...
		berechneButton.setBounds(190,50,80,20);
		add(berechneButton);
...
//		g.fillPolygon(px, py, 3);
		...
		for(i=2;i<webZaehler;i++)
		{
			g.drawLine(50+mengeA[i-2],150-preisA[i-2],50+mengeA[i-1],150-preisA[i-1]);
			//g.drawString("Z"+webZaehler,150,100);
			//g.drawString("M"+mengeA[webZaehler-1],150,120);
			//g.drawString("P"+preisA[webZaehler-1],150,140);
		}
		//g.setColor(Color.red);
		//g.drawOval(50+menge-5,150-menge-5,10,10);
...
//		py[2] = 50;
//		g.fillPolygon(px, py, 3);
		g.drawString("Harald Schellinger",150,200);
	}
